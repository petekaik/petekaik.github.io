jQuery(document).ready(function() {
  ...
  jQuery("#chores").on("click", ".chorebuttons", function() {
    ...
    // !! IS THIS SHEET FUNCTION INFO LOCALIZED?
...
/**
 * Print the names and rewards of tasks in a spreadsheet:
 */
function listChores() {
...
function bookChore(choredetails) {
  // ugly workaround for insert triggering multiple times
  if (choredetails != null) {
    ...
    request.then(
      function(response) {
        ...
        jQuery("#confirmation").hide();
        jQuery(".chorebuttons").show();
        // notifications not playing nicely...
        $("#notification")
          .fadeIn(400, function() {
